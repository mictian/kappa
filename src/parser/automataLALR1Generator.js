define(['../utils/obj', '../data/grammar', '../data/itemRule', '../data/automata', './automataLRGeneratorBase'], function(k)
{
	'use strict';
	...
	* @classdesc This class is reponsible for given a grammar create a new LR(0) automata */
	var AutomataLALR1Generator = (function(_super)
	{
	...
	k.parser = k.utils.obj.extend(k.parser || {}, {
		AutomataLALR1Generator: AutomataLALR1Generator
	});
